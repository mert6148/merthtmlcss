...
$iletisimLink = '<a href="mailto:' . $iletisim . '?subject=İletişim&body=Merhaba, Merthtmlcss ile ilgili bir sorum var.">Bize e-posta gönderin</a>';
@endphp
<!DOCTYPE html>
<html lang="tr">
<head>
...
<body class="site-body">
    <div class="bilgi-kutusu">
        ...
        <div class="bilgi-aciklama">Bu proje, modern web geliştirme teknolojilerini bir araya getiren örnek bir projedir. HTML, CSS ve JavaScript teknolojileri kullanılarak oluşturulmuştur.</div>
    ...
    <section id="anasayfa">
        <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=cover&w=400&q=80" alt="Web Geliştirme" id="anasayfa-img">
        <h1>Merthtmlcss'e Hoş Geldiniz</h1>
        <p id="php-mesaj">
          Merthtmlcss, modern web geliştirme için HTML, CSS ve JavaScript teknolojilerini bir araya getiren örnek bir projedir.
        </p>
    ...
    <section class="iletisim-kutusu">
        ...
        <p class="iletisim-aciklama">Her türlü soru, görüş ve iş birliği için bana ulaşabilirsiniz. Size en kısa sürede dönüş yapacağım.</p>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        btn.addEventListener("click", function() {
            ...
            btn.textContent = ekBilgi.classList.contains("goster") ? "Ek Bilgiyi Gizle" : "Ek Bilgi Göster";
        });
    });
    ...
    document.getElementById('eposta-btn').addEventListener('click', function() {
        window.location.href = "mailto:{{ $iletisim }}?subject=İletişim&body=Merhaba, Merthtmlcss ile ilgili bir sorum var.";
        const bilgi = document.getElementById('eposta-bilgi');
        bilgi.textContent = "E-posta uygulamanız açılmadıysa, {{ $iletisim }} adresine manuel olarak e-posta gönderebilirsiniz.";
