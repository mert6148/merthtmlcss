...
-- Üretim Zamanı: 12 Eki 2025, 18:43:08
-- Sunucu sürümü: 9.1.0
-- PHP Sürümü: 8.3.14
...
CREATE TABLE IF NOT EXISTS `channel` (
  `channelCreate` int NOT NULL,
  `channelID` varchar(192) COLLATE utf16_turkish_ci NOT NULL
...
--
-- Tablo için tablo yapısı `controller`
--

DROP TABLE IF EXISTS `controller`;
CREATE TABLE IF NOT EXISTS `controller` (
  `themeManager` int NOT NULL,
  `formManager` int NOT NULL,
  `socialManager` int NOT NULL,
  `contactManager` int NOT NULL,
  `xmlManager` int NOT NULL,
  `performanceManaager` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf16 COLLATE=utf16_turkish_ci;
