...
try {
    ...
    if (in_array($database_name, $databases)) {
        ...
        echo "<div class='info'>💡 Çözüm: install_database.php scriptini çalıştırın.</div>";
    }
    ...
    echo "<div class='step'>";
    echo "<h3>📋 Adım 8: Genel Durum Raporu</h3>";
    ...
    if (!$checks['database_exists']) {
        ...
        echo "<ul>";
        echo "<li>install_database.php scriptini çalıştırın</li>";
...
echo "<div class='step'>";
echo "<h3>📚 phpMyAdmin Kontrol Adımları</h3>";
echo "<div class='info'>phpMyAdmin üzerinden manuel kontrol için:</div>";
echo "<ol>";
echo "<li>phpMyAdmin'e giriş yapın</li>";
echo "<li>'merthtmlcss' veritabanını seçin</li>";
echo "<li>Sol menüden tabloları kontrol edin</li>";
echo "<li>Her tablonun yapısını inceleyin</li>";
echo "<li>Veri sayılarını kontrol edin</li>";
echo "<li>İlişkileri kontrol edin</li>";
echo "<li>Kullanıcı yetkilerini kontrol edin</li>";
echo "</ol>";
echo "</div>";
?> 